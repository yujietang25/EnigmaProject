...
//    /**
//     * 这个方法将会创建一个可以对a，b，c，d加密的恩格码机，注意这种恩格码机有固定的3个转轮，每2个转轮之间的连线是一个预先写好的，其余和标准恩格码机无异。
//     */
//    public EnigmaMachine() {
//        rotor1InputIndexList = EnigmaRotorGenerator.getRotor1InputIndexList(4);
//        rotor1 = new Rotor(0, Arrays.asList(new Node(1), new Node(3), new Node(0), new Node(2)), Arrays.asList(new Node(2), new Node(0), new Node(3), new Node(1)));
//        rotor2 = new Rotor(0, Arrays.asList(new Node(0), new Node(3), new Node(1), new Node(2)), Arrays.asList(new Node(0), new Node(2), new Node(3), new Node(1)));
//        rotor3 = new Rotor(0, Arrays.asList(new Node(2), new Node(3), new Node(0), new Node(1)), Arrays.asList(new Node(2), new Node(3), new Node(0), new Node(1)));
//        reflectBoard = new ReflectBoard(Arrays.asList(new Node(2), new Node(3), new Node(0), new Node(1)));
//    }
